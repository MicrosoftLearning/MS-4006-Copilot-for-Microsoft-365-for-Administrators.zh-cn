...
6. 在“输入密码”对话框中，输入实验室托管提供商提供的管理密码，然后选择“登录”************。 如果需要，请完成 MFA 登录过程。
...
9. 如果出现“发现更多应用”窗口或“使用 Microsoft 365 创建”窗口，请选择窗口顶角的“X”将其关闭************。 
...
16. 记下“组织信息”窗格顶部指示更改已保存的消息****。 选择窗格顶角的 X 将其关闭。****
