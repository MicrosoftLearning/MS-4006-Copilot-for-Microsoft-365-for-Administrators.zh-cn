...
12. 首先以 Joni Sherman 身份登录到 Microsoft 365。**** 在“登录”窗口中，输入 **JoniS@xxxxxZZZZZZ.onmicrosoft.com**（其中 xxxxxZZZZZZ 是你的实验室托管提供商提供的租户前缀）。**** <br/>

    **重要提示：** 实验室托管提供商已将 **管理员密码** 分配给 MOD 管理员帐户，你在创建 Holly Dickson 的帐户时，已将此相同的 **管理员密码** 分配给该帐户。 但实验室托管提供商为所有其他预定义用户帐户分配了不同的 **用户密码**。 今后，在以 MOD 管理员或 Holly Dickson 以外的任何用户身份登录时，必须输入此 **用户密码**，而不是 **管理员密码**。 <br/>

    由于你是以 Joni Sherman 身份登录的，因此请在“输入密码”窗口中输入此 **用户密码******。 如果需要，请完成 MFA 登录过程。

13. 在“保持登录?”窗口中，选中“不再显示此内容”复选框，然后选择“是”。************ 如果出现“保存密码”窗口，请选择“永不”。********

14. 如果页面中间出现“欢迎使用 Microsoft 365”对话框，请选择向前箭头 (>) 两次，然后选中复选标记将其关闭。****

15. 如果出现“查找更多应用”窗口，请选择窗口右上角的 X 将其关闭。********
...
18. 现在，你将以 Lynne Robbins 的身份重新登录到 Microsoft 365。**** 在当前的 Edge 浏览器选项卡中，它应显示一条消息，指示“Joni，你现已退出登录”。******** 在此窗口中，你可以选择以 Joni 的身份重新登录或以其他用户的身份登录。 <br/>
    ...
    选择“切换到其他帐户”，然后在显示的“电子邮件地址”字段中输入 ****LynneR@xxxxxZZZZZZ.onmicrosoft.com（其中 xxxxxZZZZZZ 是你的实验室托管提供商提供的租户前缀），然后选择“登录”。************ 在“输入密码”窗口中****，输入实验室托管提供商提供的 **用户密码**，然后选择“登录”****。 如果需要，请完成 MFA 登录过程。 

19. 如果出现“欢迎使用 Microsoft 365”对话框，请选择向前箭头 (>) 两次，然后选择复选标记以关闭窗口。****

20. 如果出现“查找更多应用”窗口，请选择窗口右上角的 X 将其关闭。********
