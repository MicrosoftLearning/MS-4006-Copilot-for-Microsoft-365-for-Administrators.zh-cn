...
1. 你仍以本地 adatum\administrator 帐户的身份登录到 LON-CL1，在 Edge 浏览器中，你仍以“Holly Dickson”身份登录到 Microsoft 365********。 
...
5. 在向导中，在出现的“安装 **Microsoft Purview 信息保护客户端****”窗口中，选择“我确认用于 Office 的 AIP 外接程序将卸载（必需）”复选框，并清除（取消选中）“向 Microsoft 发送使用情况统计信息以帮助改进 Microsoft Purview 信息保护”复选框********。 然后，选择“我同意”按钮****。
...
4. 首先，为存储在 SharePoint 和 OneDrive 中的 Office 联机文件启用敏感度标签。 <br/>
    ...
    在 Microsoft Purview 门户导航窗格的“解决方案”部分，选择“信息保护”，然后选择“标签”****************。

5. 在“标签”页上，页面中间应显示以下消息****：你的组织尚未开启处理 Office 联机文件（已应用加密的敏感度标签且存储在 OneDrive 和 SharePoint 中）中的内容的功能。**** 可以在此处启用该功能，但请注意，多地理位置环境需要其他配置。 <br/>
...
8. 在显示的“自动标记”对话框中，选择“确认”以确认是否要为 SharePoint 和 OneDrive 中的文件启用 PDF 保护********。 
